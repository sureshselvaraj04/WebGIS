...
map.getView().fit([8490665.683496, 1082838.814365, 8497369.920389, 1087114.518751], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">KADAKKARA PANCHAYAT : WEB GIS</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (40 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This is a test webgis map created by SRS';
            }
